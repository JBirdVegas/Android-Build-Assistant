#!/bin/bash
PROGNAME="build_assist"
PROGVERSION="v3 alpha"
#chmod a+x <filename>
# ! run as root !
#
...
usage()
{
	echo -e "Usage: $PROGNAME $PROGVERSION [-s] [-c]"
	echo -e "\t-s       ... Builds Snkbitten ROM for D1"
	echo -e "\t-c path  ... Builds CyanogenMod's ROM for many devices"
}
